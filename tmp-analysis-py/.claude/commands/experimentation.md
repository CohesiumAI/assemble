...
description: "Cycle d'expérimentation A/B — hypothèse, implémentation, mesure et décision"
trigger: /experiment-cycle
output_dir: "{cohesium_output}/experiment_{timestamp}"
steps:
  - step: 1
    agent: pm
