...
module.exports = {
  ...
  generate(projectDir, { agents = [], skills = {}, workflows = [], commands, orchestrator, config = {} }) {
    ...
    // 2a. /go — routing entry point
    {
      ...
      content += '3. For COMPLEX tasks, the Spec-Driven Methodology is MANDATORY — all 6 phases (BRAINSTORM → SPECIFY → PLAN → TASKS → IMPLEMENT → CLOSE) must be executed in sequence. No phase may be skipped, even if the brief seems complete. See routing.md for details.\n';
